...
const getFeedsNFTs = async (
  ...
  try {
    ...
    let consulta = address
      ? `${API_URL}/api/Feed/GetNfts?page=${page}&walletAddress=${address}&IsTwitter=true`
      : `${API_URL}/api/Feed/GetNfts?page=${page}&IsTwitter=true`;
...
const getFeedsDAOs = async (
  ...
  try {
    ...
    //DAOs
    let consulta = address
      ? `${API_URL}/api/Feed/GetDaos?page=${page}&walletAddress=${address}&IsTwitter=true`
      : `${API_URL}/api/Feed/GetDaos?page=${page}&IsTwitter=true`;
    result = await fetch(consulta, {
      method: "GET",
    });
    data = await result.json();
...
const getFeedsTOKENs = async (
  ...
  try {
    ...
    //TOKENs
    let consulta = address
      ? `${API_URL}/api/Feed/GetTokens?page=${page}&walletAddress=${address}&IsTwitter=true`
      : `${API_URL}/api/Feed/GetTokens?page=${page}&IsTwitter=true`;
    result = await fetch(consulta, {
      method: "GET",
    });
    data = await result.json();
...
const getFeedsPOAPs = async (
  ...
  try {
    ...
    //Poaps
    let consulta = address
      ? `${API_URL}/api/Feed/GetPoaps?page=${page}&walletAddress=${address}&IsTwitter=true`
      : `${API_URL}/api/Feed/GetPoaps?page=${page}&IsTwitter=true`;
    result = await fetch(consulta, {
      method: "GET",
    });
    data = await result.json();
...
const getFeedsMIRRORs = async (
  ...
  try {
    ...
    //Mirrors
    let consulta = address
      ? `${API_URL}/api/Feed/GetMirrors?page=${page}&walletAddress=${address}&IsTwitter=true`
      : `${API_URL}/api/Feed/GetMirrors?page=${page}&IsTwitter=true`;
    result = await fetch(consulta, {
      method: "GET",
    });
    data = await result.json();
...
////////////////////////////////////////////////////////////////////////////////////
export const FeedTwitterScreen: FC = () => {
  ...
  return (
    <>
      ...
      {address?<TabsFeed href={"/feedTwitter"} />:<TabsFeed href={"/feedTwitter"} notAddress={true} />}
