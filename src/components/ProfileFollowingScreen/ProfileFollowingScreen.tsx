...
export const ProfileFollowingScreen: FC = () => {
  ...
  const { loading, Wallets, setPage ,loadingNextPage } = useWalletsfollowings({
          ...
          <div className="w-full px-2 sm:px-[10%] pt-5">
              <div className="relative">
                ...
                <div className="relative flex justify-center">
                  ...
                  accounts followed by {heroAddress}
                  </span>
                </div>
              </div>
