...
const getFeedsNFTs = async (
  ...
  try {
    ...
    let consulta = address
      ? `${API_URL}/api/Feed/GetNfts?page=${page}&walletAddress=${address}&IsFwb=true`
...
const getFeedsDAOs = async (
  ...
  try {
    ...
    //DAOs
    let consulta = address
      ? `${API_URL}/api/Feed/GetDaos?page=${page}&walletAddress=${address}&IsFwb=true`
...
const getFeedsTOKENs = async (
  ...
  try {
    ...
    //TOKENs
    let consulta = address
      ? `${API_URL}/api/Feed/GetTokens?page=${page}&walletAddress=${address}&IsFwb=true`
...
const getFeedsPOAPs = async (
  ...
  try {
    ...
    //Poaps
    let consulta = address
      ? `${API_URL}/api/Feed/GetPoaps?page=${page}&walletAddress=${address}&IsFwb=true`
...
const getFeedsMIRRORs = async (
  ...
  try {
    ...
    //Mirrors
    let consulta = address
      ? `${API_URL}/api/Feed/GetMirrors?page=${page}&walletAddress=${address}&IsFwb=true`
...
export const FeedFWBScreen: FC = () => {
  ...
  return (
    <>
      ...
      {address?<TabsFeed href={"/feedFWB"} />:<TabsFeed href={"/feedFWB"} notAddress={true} />}
